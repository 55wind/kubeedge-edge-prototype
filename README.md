...
| 节点          | 位置          |    主机名      | 组件                             |
| ------------ | ------------- | ------------- | -------------------------------- |
| 192.168.56.8 | 云侧（cloud）  | cloud.kubeedge | k8s（master）、isulad、cloudcore |
| 192.168.56.9 | 边缘侧（edge）  | edge.kubeedge | isulad、edgecore                 |

> 提示：云侧和边缘侧的主机名需要提前使用 hostnamectl 命令设置好
