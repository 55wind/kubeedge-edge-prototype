...
kubeedge-tools 工具包提供了完备的离线安装包以及部署脚本，它降低了部署复杂度，并且支持在节点无法访问外网的条件下快速搭建 KubeEdge 集群。
...
# keadm join命令在边缘侧执行
# --token 填写上方 token 值
# --cloudcore-ipport 填写云侧 IP:10000
